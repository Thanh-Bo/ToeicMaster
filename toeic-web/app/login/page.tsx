      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <div className="bg-white/80 backdrop-blur-lg p-8 rounded-2xl shadow-xl border border-white/50">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500 mt-1">Đăng nhập để tiếp tục luyện thi</p>
          </div>
          ...
          <div className="mt-6">
            ...
            <button className="mt-4 w-full flex items-center justify-center gap-3 py-3 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors">
              ...
              <span className="text-gray-600 font-medium text-sm">Đăng nhập với Google</span>
            </button>
          </div>
        </div>
